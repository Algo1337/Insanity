    ...
    if message.Args.__len__() > 1:
        if message.Args[1] == "-info":
            await message.send_embed("Info", "List of info commands\n\nKeep in mind: ``?`` stands for optional argument", {
                ...
                "**Info Commands**": "```>info```"
            }, author_name = "Insanity", author_url = "https://images-ext-1.discordapp.net/external/ucZeDO84rLbEbF6iPIw_RW5YfjsEBUMHDYgFv2tRAEQ/%3Fsize%3D1024/https/cdn.discordapp.com/icons/1441933074697949247/1ac82574fd38e50e764835eb729ddba7.png?format=webp&quality=lossless")
