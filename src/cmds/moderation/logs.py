...
__LOGS_INVALID_ARG_ERR__ = discord.Embed(title = "Deleted Message", description = "List of deleted message commands", color = discord.Colour.red())
__LOGS_INVALID_ARG_ERR__.add_field(name = "***Display the last 3 deleted messages***", value = "```>deleted```", inline = False)
__LOGS_INVALID_ARG_ERR__.add_field(name = "***Display user messages***", value = "```>delete username <count>```", inline = False)
